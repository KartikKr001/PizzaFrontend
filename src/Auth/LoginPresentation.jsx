...
function LoginPresentation({handleUserSubmit,handleUserInput}) {
    return (
        <>
            <section className="text-gray-600 body-font">
                ...
                <div className="hidden p-0 lg:w-3/5 md:w-1/2 md:pr-16 lg:pr-0 md:block">
                    ...
                    <form className="flex flex-col w-full p-8 mt-10 bg-gray-100 rounded-lg lg:w-2/6 md:w-1/2 md:ml-auto md:mt-0">
                        <h2 className="mb-5 text-xl font-medium text-gray-900 title-font">Sign in</h2>
                        ...
                        <p className="mt-3 text-xs text-gray-500">New to Pizza App? <Link to="/auth/signup" className="text-yellow-500 underline">
                                Sign up 
                            </Link>
                        </p>
                    </form>
