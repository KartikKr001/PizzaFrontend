...
function SignupPresentation({handleUserInput,handleUserSubmit}) {
    return (
        <Layout>
            <section className="text-gray-600 body-font">
                <div className="flex flex-wrap items-center h-screen px-10 py-6 mx-auto">
                    ...
                    <form className="flex flex-col w-full p-8 mt-10 bg-gray-100 rounded-lg lg:w-2/6 md:w-1/2 md:ml-auto md:mt-0">
                        <h2 className="mb-5 text-xl font-medium text-gray-900 title-font">Sign up</h2>
                        ...
                        <p className="mt-3 text-xs text-gray-500">Already have an Account? <Link to="/auth/login" className="text-yellow-500"> Login
                            </Link>
                        </p>
                    </form>
                </div>
